...
_DATA_FILENAMES = ['esp_train_list.txt','esp_test_list.txt']
_LABEL_FILENAMES = ['esp_train_annot.txt','esp_test_annot.txt']
_NUM_PER_SHARD = 50000
_IMAGE_DIRECTORY = '/home/ayushi/Git/dataset/espgame/ESP-ImageSet/images'
_TFRECORD_SUB_DIRECTORY='tfrecord'
_CLASSNAMES_FILENAME = 'esp_dict268.txt'
